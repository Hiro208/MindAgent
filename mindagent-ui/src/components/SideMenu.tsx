...
const SideMenu: React.FC<SideMenuProps> = () => {
  ...
  const items: TabsProps["items"] = [
    {
      key: "agent",
      label: <span className="select-none">Agents</span>,
      children: (
        <AgentTabContent
          agents={agents}
          onSelectAgent={() => {}}
    ...
    {
      key: "chat",
      label: <span className="select-none">Chats</span>,
      children: <ChatTabContent />,
    },
    {
      key: "knowledgeBase",
      label: <span className="select-none">Knowledge Base</span>,
      children: (
  ...
  return (
    <div className="px-4 flex flex-col h-full">
      <div className="h-14 w-full flex items-center border-b border-gray-200 bg-[#f9fafb]">
        <div className="flex items-center gap-2.5 mx-4">
          <RobotOutlined className="text-xl text-gray-900" />
          <div className="text-lg font-semibold select-none text-gray-900 tracking-wide">
            MindAgent
          </div>
        </div>
      </div>
